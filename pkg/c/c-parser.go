...
func NumericLiteral(Token string) Expression {
	return Expression{
		ExpType: "NumericLiteral",
		Val:     Token,
	}
}

/*
C in Extended Backus-Naur Form (EBNF)
{
    tokens=[
         space='regexp:\s+'
...
jump-statement ::= goto identifier ';'
                   ...
                   | break ';'
                   | return {expression}? ';'
Source : https://gist.github.com/arslancharyev31/c48d18d8f917ffe217a0e23eb3535957
*/
